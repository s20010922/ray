...
| **TAD CNN** | **TAD 高速公路監控** | **影片級 ROC 0.92** | ✅ **採用** |
...
- 影片級：ROC-AUC **0.919** / PR-AUC 0.909 / F1 0.882（TP15 FP2 FN2 TN35，acc 0.926）
- 幀級：PR-AUC 0.895 / F1 0.838
- val F1 0.835 → test 0.882，無過擬合落差。模型 MobileNetV2 解凍微調 lr 1e-4 / 15ep。
...
- 車禍：✅ 影片級 ROC 0.92，接進 serve 影片 demo，四階段全亮。
